...
export const PROVENANCE = createProvenanceRegistry([
  ...
  ,{id:'planning.goals.defaults.m4',classification:'estimated',source:{title:'Editable Milestone 4 goal and home-planning conventions',url:'model://planning/goal-defaults'},sourceType:'ConfigurablePlanningDefault',effectiveDate:'2026-09-02',retrievedDate:'2026-09-02',confidence:'low',editable:true,yearKeyed:false,locationKeyed:true,notes:'Planning feasibility conventions, not lender approval criteria; user inputs override every value.'}
]);
